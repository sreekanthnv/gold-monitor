...
def spot():
    sr = requests.get("https://api.gold-api.com/price/XAU", headers=HDR, timeout=10)
    fr = requests.get("https://open.er-api.com/v6/latest/USD", headers=HDR, timeout=10)
    price = sr.json()["price"]          # USD per troy ounce
